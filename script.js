...
imgArr[0] = "http://www.ncyu.edu.tw/files/site_content/ncyu/emblem.jpg";
imgArr[1] = "http://www.ncyu.edu.tw/files/site_content/ncyu/ncyulogo2.bmp";
imgArr[2] = "http://www.ncyu.edu.tw/NewSite/images/opening.jpg";

function showImg(){
  document.getElementById('ico').src = imgArr[i]; //指定 img 的 src
  i = (i+1) % 3; //把 i 加1 之後，除以3(因有三張圖輪播)，將樹再放回變數i裡
}
